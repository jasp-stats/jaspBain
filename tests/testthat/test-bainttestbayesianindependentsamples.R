...
test_that("BF age plot matches", {
  ...
  jaspTools::expect_equal_plots(testPlot, "BF age", dir="BainTTestBayesianIndependentSamples")
})
...
test_that("Descriptives age plot matches", {
  ...
  testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
  jaspTools::expect_equal_plots(testPlot, "descriptives age", dir="BainTTestBayesianIndependentSamples")
})
