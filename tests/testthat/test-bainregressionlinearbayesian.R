...
test_that("Bain Linear Regression table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(1.26536373845463, 1.16763339997158, 0.0299034902115412, 0.0291567752383641,
			 0.0294167724893267, "H1", 35.3064243610644, 35.3064243610644,
			 0.904209587796401, 0.881630723813583, 0.889492415056246, "H2",
			 4.00115272103433, 2.57266861476783, 0.0658869219920581, 0.0642416708578264,
			 0.0648145276872849, "H3", "", "", "", 0.0249708300902267, "",
			 "Hu", "", 0.646050946903171, "", "", 0.0162762847671429, "Hc"
			))
})
...
test_that("Bain Linear Regression table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(8.64985149525717e-62, 8.64985149525717e-62, 4.77369802413396e-63,
			 4.52402518195759e-63, 4.76569029151098e-63, "H1", 595.136041110726,
			 18.1198128820191, 1, 0.947698232918355, 0.99832253054498, "H2",
			 "", "", "", 0.052301767081645, "", "Hu", "", 0.0304465057236349,
			 "", "", 0.00167746945502035, "Hc"))
})
...
test_that("Bain Linear Regression table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(1.05833115528427e-162, 1.05833115528427e-162, 2.66173007733809e-164,
			 2.59642921474827e-164, 2.65969937029844e-164, "H1", 1309.7405575344,
			 39.7610247671194, 1, 0.975466760079922, 0.999237072512747, "H2",
			 "", "", "", 0.0245332399200784, "", "Hu", "", 0.0303579396227676,
			 "", "", 0.000762927487252757, "Hc"))
})
